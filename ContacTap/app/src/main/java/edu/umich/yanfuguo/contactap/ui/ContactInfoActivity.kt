...
class ContactInfoActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.menu_contact_info_activity, menu)
        return true
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when(item.itemId){
            R.id.tick_Button -> {
                toast("Edit saved!")
                // TODO: go back to home page with saving edit
                return true
            }
            R.id.cross_discard_edit_Button -> {
                // TODO: go back to home page without saving edit
                return true
            }
